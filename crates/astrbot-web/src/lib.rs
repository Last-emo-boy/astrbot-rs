...
pub use management::{
    ...
    ManagementPlatformSessionDescriptor, ManagementSkillActivationRequest,
    ManagementSkillActivationResponse, ManagementSkillCatalogResponse,
    ManagementSkillDeletePlanRequest, ManagementSkillDeletePlanResponse, ManagementSkillDescriptor,
