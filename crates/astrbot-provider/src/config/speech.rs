...
impl SpeechToTextProviderConfig {
    pub fn mock(id: impl Into<String>, text: impl Into<String>) -> Self {
        Self {
            id: id.into(),
            provider_type: MOCK_SPEECH_TO_TEXT_PROVIDER_TYPE.to_string(),
            enabled: true,
            model: None,
            api_base: None,
            api_key: None,
    ...
    pub fn openai(
        ...
        Self {
            id: id.into(),
            provider_type: OPENAI_SPEECH_TO_TEXT_PROVIDER_TYPE.to_string(),
            enabled: true,
    ...
    pub fn xinference(
        ...
        Self {
            id: id.into(),
            provider_type: XINFERENCE_SPEECH_TO_TEXT_PROVIDER_TYPE.to_string(),
            enabled: true,
            model: Some(model.into()),
            api_base: Some(api_base.into()),
            api_key: None,
...
impl fmt::Debug for SpeechToTextProviderConfig {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("SpeechToTextProviderConfig")
            .field("id", &self.id)
